  ...
  return (
    <>
                  ...
                  <Row className="mb-2">
                    <Col md={9} className="pr-0">
                      <Input
                        ...
                        onChange={(evt) => {
                          setNombreCorto(evt.target.value);
                        }}
                      ></Input>
                      <Input
                        className="p-2"
                    ...
                    >
                      <Button size="sm" color="success" onClick={updateItem}>
                        Guardar
                      </Button>
                      <Button
                        size="sm"
      ...
      <Modal isOpen={confirmDel} size="lg">
        <ModalBody>
          <h5 className="mb-4">
            ¿Está seguro que quiere borrar este ítem? {item.nombre_corto}
          </h5>
          <ModalFooter>
            <Button
              className="neutro"
