...
const NuevaSeccion = (props) => {
  ...
  const guardar = () => {
    props
      .fetchAltaSeccion(props.idEmpresa, nuevoNombre, observacion)
      .then(function (res) {
  ...
  return (
    <div
      className={
        edicionEnable
          ? "col-md-4 seccion-item nueva-seccion nueva-seccion-editar pl-0"
          : "col-md-4 seccion-item nueva-seccion pl-0"
      }
    >
      <Tarjeta>
        {!edicionEnable && (
          <h3 className="titulo-seccion">
            <Button color="link" onClick={crearSeccion} href="#">
              Nueva Seccion
            </Button>
          </h3>
        )}
        {edicionEnable && (
          <div className="ml-5">
            ...
            <Button
              className="neutro float-right mt-2 mr-2"
...
export default connect(mapStateToProps, { fetchAltaSeccion })(NuevaSeccion);
