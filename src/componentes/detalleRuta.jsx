...
import { faIndustry, faTrashCan } from "@fortawesome/free-solid-svg-icons";
...
export const DetalleRuta = (props) => {
  ...
  const [
    mostrarModalConfirmarEliminarRuta,
    setMostrarModalConfirmarEliminarRuta,
  ] = useState(false);
    ...
    <Fragment>
      <Modal isOpen={mostrarModalConfirmarEliminarRuta} size="md">
        ...
        <ModalFooter>
          ...
          <Button
            className="neutro"
            onClick={() => {
              setMostrarModalConfirmarEliminarRuta(false);
            }}
          >
            No, cancelar
          </Button>
      ...
      <Row>
        ...
        <div style={{ flex: "0 0 170px" }}>
          <Button color="success" size="sm" onClick={actualizarRuta}>
            GUARDAR CAMBIOS
          </Button>
        </div>
        <div className="col-md-12">
        ...
        <div className="col-md-12 text-right mt-2">
          <Button
            ...
            size="sm"
            onClick={() => {
              setMostrarModalConfirmarEliminarRuta(true);
            }}
          >
            {" "}
            <FontAwesomeIcon icon={faTrashCan} /> ELIMINAR RUTA
          </Button>
        </div>
      </Row>
    </Fragment>
